...
@Service// @Compenent de kullanilabilir
public class JwtRequestFilter extends OncePerRequestFilter {// bu class client'den gelen sorgu(request) ile App'den gelen token compare(karsilastirma) yapar
    @Autowired
